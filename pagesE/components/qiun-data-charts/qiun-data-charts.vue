...
<script>
import uChartsMp from '@/pagesE/components/u-charts/u-charts.js';
import cfu from '@/pagesE/components/u-charts/config-ucharts.js';
// #ifdef APP-VUE || H5
import cfe from '@/pagesE/components/u-charts/config-echarts.js';
// #endif
...
import uChartsRD from '@/pagesE/components/u-charts/u-charts.js';
import cfu from '@/pagesE/components/u-charts/config-ucharts.js';
import cfe from '@/pagesE/components/u-charts/config-echarts.js';
  ...
  methods: {
    ...
    ecinit(newVal, oldVal, owner, instance){
      ...
      if (typeof window.echarts === 'object') {
        ...
        // #ifdef APP-VUE
        script.src = './pagesE/lib/app-plus/echarts.min.js';
        // #endif
        // #ifdef H5
        ...
        script.src = rooturl + 'pagesE/lib/h5/echarts.min.js';
        // #endif
