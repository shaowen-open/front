<template>
	<view class="mask" :class="!show?'':'mask-show'" :style="{backgroundColor:show?maskBg:'rgba(0,0,0,0)'}" @tap="tapMask">
		<view class="popups" :class="[theme]"
			...
			<block v-for="(item,index) in popData" :key="index" >
				<view @tap.stop="tapItem(item)"
...
<style lang="scss" scoped>
	...
	.dark{
		...
		.top-start:after {
			...
			border-style: solid;
			border-color: $uni-bg-color $uni-bg-color #4C4C4C;
		}
		.top-end:after {
			content: "";
			position: absolute;
		...
		.bottom-start:after {
			...
			border-style: solid;
			border-color: #4C4C4C $uni-bg-color $uni-bg-color ;
	...
	.light{
		...
		.top-start:after {
			...
			border-width: 0 20rpx 20rpx;
			border-style: solid;
			border-color: $uni-bg-color $uni-bg-color #fff;
		}
		.top-end:after {
			content: "";
			position: absolute;
		...
		.bottom-start:after {
			...
			border-width: 20rpx 20rpx 0 ;
			border-style: solid;
			border-color: #fff $uni-bg-color $uni-bg-color ;
