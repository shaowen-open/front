    ...
    <view class="uni-stat-box" :class="{ 'uni-stat__actived': current }">
      <view class="uni-select" :class="{ 'uni-select--disabled': disabled }">
        <view class="uni-select__input-box" @click="toggleSelector">
		  ...
		  <block v-if="showSelector">
				<i class="mini-icon mini-shangjiantou" style="font-size: 20rpx;color: #999;"></i>
		  </block>
		  <block v-else>
		  		<i class="mini-icon mini-xiajiantou" style="font-size: 20rpx;color: #999;"></i>
		  </block>
        </view>
