<template>
  <view
    ...
    <view :class="'mini-page-body ' + (isBack ? '' : 'tabbar') ">
		<navBar :back="isBack" :home="fph" title="广场" :color="global__theme__ == 'black' ? '#ffffff' : '#000000'" :background="global__theme__ == 'black' ? '#19191e' : '#ffffff'">
			<!-- #ifdef APP || H5 -->
                ...
                >
                  ...
                  <view class="area-club-info">
                    ...
                    <view class="area-club-creater">
                      <view class="area-club-creater" style="color: #6b6f77">
                ...
                >
                  ...
                  <view class="area-club-info">
                    <view class="area-club-name w-w">
                      <i class="mini-icon mini-tubiaozhizuomoban-mian_quanzi" style="color: $uni-color-primary;"></i>
                      {{ item.circle_name }}
                      <block v-if="move_post_id != 0">
                        <view class="move_to_circle" @tap.stop.prevent="movePostTo(item.id)">转移至</view>
                      </block>
...
export default {
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      title: '热门圈子 - ' + that.configData.app_title,
  ...
  onTabItemTap : function(e) {
  	// #ifndef MP-WEIXIN
  	if(e.pagePath == 'pages/tabbar/circleClass/circleClass'){
