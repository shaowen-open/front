...
$u-search-label-color: $uni-color-primary !default;
...
$u-search-input-color: $uni-color-primary !default;
$u-search-input-placeholder-color: $uni-text-color-light !default;
$u-search-action-font-size: 14px !default;
$u-search-action-color: $uni-color-primary !default;
