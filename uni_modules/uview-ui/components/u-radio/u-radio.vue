...
<script>
	...
	export default {
		...
		computed: {
			...
			elSize() {
				return this.size ? this.size : (this.parentData.size ? this.parentData.size : 42);
			},
			// 组件的勾选图标的尺寸，默认12px
			elIconSize() {
				return this.iconSize ? this.iconSize : (this.parentData.iconSize ? this.parentData.iconSize : 24);
			},
			// 组件选中激活时的颜色
			elActiveColor() {
...
<style lang="scss" scoped>
	...
	$u-radio-label-color:$uni-text-color !default;
