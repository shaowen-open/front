...
<script>
	 ...
	 * @property {String}			color			动画活动区域的颜色，只对 mode = flower 模式有效（默认color['font-color-light']）
	 * @property {String}			textColor		提示文本的颜色（默认color['font-color-light']）
...
<style lang="scss" scoped>
	...
	$u-loading-icon-text-color:$uni-text-color !default;
