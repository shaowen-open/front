...
<style lang="scss" scoped>
	...
	$u-notify-primary-bgColor: $uni-color-primary !default;
	$u-notify-success-bgColor: $uni-color-success !default;
	$u-notify-error-bgColor: $uni-color-error !default;
	$u-notify-warning-bgColor: $uni-color-warning !default;
