...
<script>
	 ...
	 * @property {String}			color			图标颜色,可接受主题色 （默认 color['font-color-base'] ）
	 ...
	 * @property {String}			labelColor		图标右侧的label文字颜色 （ 默认 color['font-color-base'] ）
...
<style lang="scss" scoped>
	...
	// 变量定义
	$u-icon-primary: $uni-color-primary !default;
	$u-icon-success: $uni-color-success !default;
	$u-icon-info: $uni-color-info !default;
	$u-icon-warning: $uni-color-warning !default;
	$u-icon-error: $uni-color-error !default;
