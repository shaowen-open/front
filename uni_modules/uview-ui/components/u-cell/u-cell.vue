...
<style lang="scss" scoped>
	...
	$u-cell-color: $uni-color-primary !default;
	$u-cell-icon-size: 16px !default;
	$u-cell-title-font-size: 15px !default;
	$u-cell-title-line-height: 22px !default;
	$u-cell-title-color: $uni-color-primary !default;
	$u-cell-label-font-size: 12px !default;
	$u-cell-label-color: $uni-text-color-light !default;
	$u-cell-label-line-height: 18px !default;
	$u-cell-value-font-size: 14px !default;
	$u-cell-value-color: $uni-text-color !default;
	$u-cell-clickable-color: $uni-bg-color !default;
