...
<script>
	import { getStore, setStore, clearStore, circleImg, clacTextLen, downloadFile, pathToBase64, base64ToPath } from '@/pagesB/components/almost-lottery/utils/almost-utils.js'
  export default {
    name: 'AlmostLottery',
    props: {
      // 设计稿的像素比基准值
      ...
      lotteryBg: {
        type: String,
        default: '/pagesB/static/almost-lottery/almost-lottery__bg2x.png'
      },
      // 抽奖按钮背景图
      actionBg: {
        type: String,
        default: '/pagesB/static/almost-lottery/almost-lottery__action2x.png'
      },
      // 是否绘制奖品名称
      prizeNameDrawed: {
				type: Boolean,
    ...
    data() {
      return {
        ...
        // 高清固定 2 倍，不再从 system 中笔记获取，因为 h5、app-vue 中单个尺寸过大时存在 iOS/Safari 无法绘制的问题，且 2 倍基本也可以解决模糊的问题
        systemPixelRatio: 2,
        // 抽奖转盘的整体px尺寸
        lotteryPxSize: 0,
        // 画板的px尺寸
