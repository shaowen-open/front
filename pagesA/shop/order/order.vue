                        ...
                        <u-collapse-item :clickable="false" :border="false" :isLink="false" :ref="'u_collapse_item_'+item.id">
                            <view class="l-collapse-title" slot="right">
                                ...
                                <view class="order-btn">
									...
									<view @tap.stop.prevent="toSliderUrl(18, item.seller_user_id)" v-if="item.seller_user_id > 0" class="btn bg2">
									    联系卖家
									</view>
                            ...
                            <view class="content-box">
                                ...
                                <view class="content-goods">
                                    <view class="goods" @tap.stop.prevent="toSliderUrl(git.goods_type == 6 ? 28 : 3, git.goods_id)" v-for="(git, gidx) in item.goods" :key="git.id">
