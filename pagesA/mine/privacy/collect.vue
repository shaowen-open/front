	...
	<view class="mini-page-body box" style="height: 100%;">
		...
		<view class="setting-box">
			<view class="row">
				...
				<view class="right">
					<view class="flex-row">
						<switch class="_switch" :color=" primaryColor " :checked=" myUserInfo.setting.privacy_collected_post_show == 1 " @change="(e) => userSettingUpdate('privacy_collected_post_show', e.detail.value ? 1 : 2)"/>
					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				pagebgcolorClass: 'pagebg_white',fph: false,mytoast_data: {},pageTheme: 'default',page__scene__: 90,
			};
		},
		/**
		 * 生命周期函数--监听页面加载
		...
		onShow: function() {
			let that = this;
			that.updateScene(90, 0, true, false, 0, 0);
		},
